/**
 * Body copy for the buyer guides.
 *
 * ─────────────────────────────────────────────────────────────────────────
 *  TODO — LAUNCH GATE. This copy has NOT been reviewed by a Nigerian lawyer.
 *
 *  It was written to fill the guides for the client preview, and it describes
 *  the Land Use Act 1978, excision, gazette, Governor's consent and payment
 *  practice as they are generally understood. It is written carefully and it
 *  is not legal advice. Because the site's whole position is that it tells
 *  buyers the truth about documentation, publishing anything inaccurate here
...
On our own listings, the title type is stated before the price, and where a plot is sold on something less than a C of O, the listing says so in those words.`,
  ...
  "excision-and-gazette-explained": `Two words appear constantly in Nigerian land adverts and are almost never explained. If you understand them, you can read a listing properly.

Begin with the problem they solve. When the Land Use Act vested land in the state, governments across the country also acquired large areas outright for public purposes — roads, schemes, future development. Land inside those acquisitions is committed. No individual can obtain good title over it, whatever the family occupying it believes and whatever they are willing to sell you.

Excision is the state releasing a defined portion of that acquired land back to the original land-owning community. It is a deliberate government act. Once excised, that portion is no longer committed, and title over it can properly be granted, transferred and registered.

A gazette is the official state publication in which the excision is recorded. It is the proof. It names the village or family, describes the area released, and gives the survey particulars. When a seller says land is excised, the honest follow-up is simple: which gazette, what number, what year, and what page. A seller who cannot answer that has told you the excision is a claim rather than a fact.

Read the gazette against the survey. This is where the market's most common disappointment lives. Excisions are granted over a defined area, and that area is frequently smaller than the land the community actually occupies and sells. A gazette can be entirely genuine and the specific plot you are being offered can still sit outside the excised portion. The document proves something real about somewhere — the survey is what proves it is about your plot.

The way to close that gap is charting. Your surveyor submits the survey plan to the office of the state Surveyor-General, and it is checked against the government's own records to establish what the land falls within: an excision, a committed acquisition, a road setback, a drainage right of way. Charting is cheap and quick relative to what it tells you. Anyone buying land without a C of O should treat it as compulsory rather than optional.

Where does excised land sit against a Certificate of Occupancy? Below it, but legitimately so. Land properly excised and gazetted, held by the family that received it, sold with a registered survey and a deed, is a real position with a real path forward — the buyer or the estate can apply for a certificate over it in due course. It is not the same as holding one already, and the price should reflect the difference.

Two practical cautions. A gazette is not a title document; it says land was released to a community, not that any particular person within that community may sell it to you. Establish who within the family has authority to sell, and get the signatures of the accredited representatives rather than of whoever appeared on the day. And be wary of an excision described as pending or in process. Applications can sit for years and many are never granted. Pending is not a state of title. It is a hope, and hopes should not be priced as facts.`,

  "when-a-survey-plan-is-all-there-is": `Some plots are sold on a registered survey and nothing else. No certificate, no excision, no gazette. It is a real position in this market, it is not automatically a fraud, and it is where a great deal of money is lost. It deserves a plain explanation rather than a warning.

A survey plan is a document prepared by a licensed surveyor that fixes a parcel of ground in space. It carries coordinates, beacon numbers, dimensions and an area, and once lodged it carries a registration number issued by the state Surveyor-General. A registered survey answers one question completely and one question not at all.

The question it answers is where. Given a registered survey you can go to the ground, find the beacons, and know that the land you are standing on is the land in the document. That is not a small thing. A surprising share of disputes are simply two people describing different ground in similar words.

The question it does not answer is whose. A survey plan says nothing about ownership. It does not say the seller owns the land, that they are entitled to sell it, or that the state agrees any of it. A survey can be perfectly genuine, properly registered, and describe land the seller has no right to transfer.

Between the two sits the thing you must actually do, which is charting. Submit the survey to the Surveyor-General's office and have it checked against government records. Charting tells you whether the parcel is under acquisition, whether it has been excised, whether it sits in a right of way or a road setback. Land under a committed acquisition cannot be regularised by anyone at any price, and charting is how you find that out before you pay rather than after.

If it charts clean and is not excised, you are buying from a family or community on the strength of customary ownership, evidenced by a deed and witnessed by accredited family representatives. Whether that is acceptable depends on facts you can establish: who the family is, who is authorised to sign, whether other branches dispute the sale, whether the same land has been sold before. Ask directly. Ask for the family's own documents. Ask what happened to the neighbouring plots and to the people who bought them.

Price is the last piece, and the most misread. Survey-only land is cheaper, and it should be, because the buyer is taking on both risk and future cost. Regularisation, where it is available, is a process with fees and a timeline that is rarely short. A plot at a third of the price of a titled plot down the road is not necessarily a bargain; it may simply be correctly priced for what it is. The bargain is the plot priced as survey-only that turns out to have a clean path to title. The trap is the plot priced near a titled plot on the strength of a promise.

We sell some plots on a registered survey only. Those listings say exactly that, on the card and on the page, before the price. They set out what we hold and what we do not, and the price reflects the position. We would rather sell you that plot with your eyes open than have you find out afterwards.`,

  "how-to-verify-a-plot-before-you-pay": `Verification is a sequence, and the order matters. Each step is cheap relative to the purchase, and each one can end the process before you spend anything on the next.
...
Two things worth saying plainly. Use your own solicitor, not the seller's, and not one the seller recommends. The fee is small next to the purchase and their duty is to you alone. And be suspicious of urgency. Pressure to pay today, to secure a price before it rises, to avoid missing an allocation, is the most reliable warning sign in this market. Land that is genuinely available on Monday is genuinely available on Friday. Anyone who needs your money before you have finished checking is telling you what checking would reveal.`,
  ...
  "the-site-visit-checklist": `A site visit is not a viewing. You are not there to be impressed; you are there to establish facts that are difficult to establish anywhere else. Go with the survey plan, go in daylight, and if you can, go once with the seller and once without.

**Find the beacons.** The survey plan gives beacon numbers and coordinates. Locate them on the ground and confirm the plot you are standing on is the plot in the document. If the beacons cannot be found, or the seller is reluctant to walk the boundary, stop there. Take a surveyor if you are not confident; a few hours of their time is trivial against the cost of the wrong plot.

**Check the access.** Can a vehicle reach the plot today, in the rain? An access road on a layout drawing is a plan, not a road. Establish whether the route crosses land belonging to someone else, and whether that has been formally dealt with. Landlocked plots are common and are very hard to resell.

**Look at the levels.** Stand on the plot and work out where water goes. Land at the bottom of a slope collects everything that falls above it. Ask what the plot looks like in September, at the height of the rains, and be sceptical of an answer given in January. Filling and reinforcing a low plot can cost more than the plot did.

**Look for signs of occupation or use.** Crops, footpaths, structures, graves, dumped material. Each represents somebody with an interest or a habit, and each is a conversation you would rather have now.

**Read the neighbours.** What is being built around the plot, and to what standard? Is anyone actually building, or has nothing moved in two years? Are there completed houses with people living in them? An estate where people have moved in is an estate that delivered. Ask a resident how their allocation went and how long their documents took.

**Look for the marks of a dispute.** Painted warnings on walls, notices of ownership, court references, competing signboards. These are worth taking seriously even when the seller has an explanation.

**Check what the estate promised against what exists.** Perimeter fencing, gatehouse, drainage, graded roads, electricity. Note what is built, what is started and what is only drawn. Ask for dates on the rest, in writing.

**Establish distances yourself.** Drive from the plot to the nearest main road, market, hospital and school, and time it. Marketing distances are measured optimistically and often in a straight line.

**Ask about the neighbours' documents.** What title did people who bought here receive, and how long did it take? Has anyone completed the process? This is the most useful question on the list and almost nobody asks it.

**Photograph everything.** The beacons, the boundaries, the access, the surrounding plots, the signage. Date-stamped photographs settle arguments later and cost nothing now.

Finally, notice how you are being handled. A seller who walks the boundary with you, points out the low corner, and tells you which documents are outstanding is a seller with less to hide than one who keeps you in the car and talks about appreciation. We give our own buyers this list, and we would rather you use it on us than not use it at all.`,

  "questions-to-ask-a-land-seller": `Ask these before a deposit, and ask for the answers in writing. A seller who answers all eleven plainly is worth dealing with. A seller who is vague on more than one is telling you where the problem is.

**1. What exactly is the title on this plot?** Not "it is good title" — the actual position. A certificate, an excision, a registered survey and nothing more. Get the words, and get them written down.

**2. Whose name is on the documents?** And what is the chain between that person and the person selling to me? Ask to see every link, including any deed and any consent already granted.

**3. May I have copies for my solicitor?** The answer should be yes without hesitation. Anything else ends the conversation.

**4. Has the land been charted?** If yes, ask for the result. If no, ask whether you may chart it before paying, and treat a refusal as decisive.

**5. Is any part of the plot affected by a government acquisition, a road setback, a drainage alignment or a power line?** Ask it as a direct question and get a direct answer, because a partial answer here is the one most likely to be technically true and materially misleading.

**6. Who signs, and on what authority?** For a company, confirm incorporation and the signatory's authority. For family land, ask who the accredited representatives are and how you can verify that independently.

**7. What is the total cost of ownership?** The plot price is rarely the whole figure. Ask about deed of assignment fees, survey fees, development or infrastructure levies, consent fees, agency, legal, and anything payable at allocation. Ask for the full schedule before you commit to the first payment.

**8. What exactly will I receive, and when?** A receipt, a contract of sale, a deed, an allocation letter, a survey in your name. Ask for each item with a timeline attached, and be direct about what happens if the timeline slips.

**9. Has this plot been sold before?** And has any plot on this scheme been the subject of a dispute or a claim? Ask it plainly and watch the answer.

**10. Where do I pay, and to whom?** The answer should be a company account, against an invoice and a receipt. Never cash, never an individual's personal account, never a third party you have not been introduced to.

**11. What happens if I miss an instalment?** Cover this before you sign, not when it happens. Ask about the grace period, the penalty, whether the plot can be reallocated, and what is refunded if the plan is terminated — the amount, the deductions, and the timeline.

Two habits worth building. Put the questions in an email, so the answers arrive in writing and become part of the record. And ask the same question twice on different days if the first answer was vague; consistency is informative.

None of this is adversarial. A serious seller expects these questions and has the answers ready. We publish most of them on the listing before you have to ask.`,

  "reading-a-land-payment-plan": `A payment plan makes land reachable for people who cannot pay in one sum, and that is a genuinely good thing. It also introduces terms that most buyers never read until they need them. Read them at the start, when you have leverage, rather than at the end, when you do not.
...
Our own plans and their terms are set out on each listing that offers one. If anything in this guide is not answered there, ask us, and we will put the answer in writing.`,
  ...
  "deposit-and-default-what-happens": `Nobody plans to miss an instalment. Incomes move, businesses have bad quarters, families have emergencies. What matters is that you know the consequences before you need to, because the terms are agreed at the beginning and almost never renegotiated in a crisis.
...
On our own listings, the payment plan terms — including the default and refund position — are stated on the listing rather than kept for the contract. If a term would upset you to discover later, we would rather you saw it now and chose differently.`,
  ...
  "paying-in-full-versus-a-plan": `Both are legitimate. Which is right depends on facts about you, not on which the seller prefers, and it is worth taking a moment over because the difference compounds.
...
Our listings that offer a plan show its terms alongside the outright price, so the comparison can be made on the page rather than reconstructed from a conversation.`,
  ...
  "what-estate-service-charges-cover": `A service charge is what keeps an estate working after the developer has sold the last plot. Buyers tend to treat it as an annoyance, which it is not; the estates that hold their value are the ones that collect it and spend it well. What matters is knowing what you are paying for, how the figure is arrived at, and what happens if it rises.

**Typically covered.** Security — the gatehouse, personnel, and often lighting at the perimeter. Estate roads and drainage, which need clearing before the rains and repair after them. Common-area electricity, including street lighting and any shared pumps. Refuse collection. Landscaping and maintenance of green areas. Management costs, meaning the people who administer all of the above. Where an estate has a borehole and reticulated water, that appears here too.

**Typically not covered.** Anything inside your own boundary. Your electricity, your water consumption where it is metered, your building maintenance, your own security arrangements. Nor, usually, capital projects — a new borehole or a road rebuilt from the base is often a separate levy rather than part of the annual charge.

**How it is calculated.** Ask directly. Common bases are a flat charge per plot, a rate per square metre, or a share of a budgeted total. A per-square-metre basis means a larger plot pays more, which may or may not suit you. Ask whether undeveloped plots pay, and at what rate — some estates charge them less, which is fair while nothing is occupied and becomes contentious later.

**Ask for the budget and the accounts.** A well-run estate publishes a budget before the year and accounts after it. Ask to see both. An estate that cannot show you where last year's money went is telling you something about how this year's will be spent.

**Ask how it changes.** Whether increases require a residents' vote or are set by the managers, whether there is a cap, and what the charge has actually been for the last three years. That last figure is more informative than any assurance about the future.

**Ask who manages it,** and whether that is the developer, a separate facility manager, or a residents' association. Ask when control transfers to residents, because the point at which an estate stops being run by its developer is a real milestone and is often undocumented.

**Ask what happens if people do not pay.** Non-payment is the most common cause of estate decline. Ask what enforcement exists and whether it is used. An estate with no answer will eventually have no lighting.

**Budget for it as an ongoing cost of ownership.** For a plot you are not yet building on, service charge may be your only recurring outgoing, and it runs whether or not you have started. Include it in the figure you use to decide whether the purchase works, alongside ground rent and any land use charge that applies in your state.

For each of our estates, what the charge covers, how it is calculated and who manages it is set out on the estate page. If you are comparing us against another scheme, ask them the same questions.`,

  "what-to-expect-after-allocation": `Allocation is the point at which a plot stops being a purchase and becomes yours in a practical sense. What follows is a sequence most buyers have not been told about, and the gap between expectation and reality is where frustration lives.
...
**A realistic frame.** From allocation to full registration is a process measured in months rather than weeks, and in some states considerably longer. A developer who tells you otherwise is either inexperienced or managing you. Our own position on each estate — what has been obtained, what is in progress, and what has not been started — is published on the estate page, including where the answer is unflattering.`,
  ...
  "building-approvals-in-a-managed-estate": `Building inside a managed estate involves two separate permissions, and confusing them is the most common cause of a stalled project. One comes from the estate. The other comes from the government. You need both, and neither substitutes for the other.
